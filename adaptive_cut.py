...
def get_global_e(filename):
	...
	#return mm08_e_adaptive
	return kd06_e_adaptive
...
if __name__ == "__main__":
	...
	for alpha_key,marker,color in zip(alpha_keys,markers,colors):
		...
		for rundir in rundirs:
			...
			for filename in filenames:
				mm08_e_adaptive = get_global_e(filename)
		...
		ax1.plot(qs, es_adaptive, marker=marker, color=color, label=alpha_key, markersize=6, linestyle='None',linewidth=0.5, mfc='None')
